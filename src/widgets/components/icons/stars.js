...
export default (props) => {
  return (
    <svg width="12px" height="12px" viewBox="0 0 538.6 538.6" enableBackground="new 0 0 538.6 538.6">
      <g>
        <path className={ props.style } d="M501.2,218.5c0,2-0.7,4.1-2,6.3c-1.3,2.3-3.1,4.7-5.4,7.3l-102.1,99.6l23.9,140.6c0,0.7,0.1,1.5,0.2,2.4
